    ...
    if not profiles:
        ...
        sample_profiles = [
            ProfileCreate(
                ...
                skills=["React", "JavaScript", "TypeScript", "CSS", "Accessibility", "Redux"],
            ...
            ProfileCreate(
                ...
                skills=["Python", "PyTorch", "TensorFlow", "NLP", "Machine Learning", "Deep Learning"],
                interests=["Artificial Intelligence", "Natural Language Processing", "Research"],
            ...
            ProfileCreate(
                ...
                interests=["Cloud Computing", "Infrastructure as Code", "Site Reliability"],
            ...
            ProfileCreate(
                ...
                skills=["React Native", "Flutter", "JavaScript", "Dart", "iOS", "Android"],
            ...
            ProfileCreate(
                ...
                interests=["Data Science", "Financial Analysis", "Statistical Modeling"],
        ...
        try:
            ...
            if results:
                ...
                for j, result in enumerate(results):
                    print(f"  Match #{j+1}: {result['name']} (Score: {result['score']})")
