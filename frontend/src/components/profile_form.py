    ...
    with st.form("profile_form"):
        ...
        with col1:
            skills = st.multiselect(
                "Skills*",
                options=["Python", "JavaScript", "React", "Node.js", "Machine Learning", "Data Science", "FastAPI", "DevOps"],
                default=None
            )
        with col2:
            interests = st.multiselect(
                "Interests*",
                options=["Web Development", "AI/ML", "Mobile Development", "Cloud Computing", "Blockchain", "IoT"],
                default=None
            )
        
        github_url = st.text_input("GitHub Profile URL", placeholder="https://github.com/yourusername")
        linkedin_url = st.text_input("LinkedIn Profile URL", placeholder="https://linkedin.com/in/yourusername")
